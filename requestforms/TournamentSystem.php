...
<div class="container" id="reqform-container">
    <div class="container pl-5 pr-0" id="outline-request">
        <div class="row mt-5 mb-3 pt-5 pb-2 col-12 d-flex justify-content-center">    
            <h3 id="req-head"> Administrasjon/klubbdrift - Turneringssystem</h3> <!-- Change names in this line -->
        </div>    
        <div class="row d-flex col-12 px-0 justify-content-center">
            <form class="col-12 px-0" action="./requestforms/TournamentSystemSubmit.php" enctype="multipart/form-data" method="POST" id="detail-form">
                <div id="div1" class="form-group row d-flex col-12 justify-content-center">
                <input type="number" class=" reqinput-border form-control ml-3 col-11 col-md-3" id="nooftournaments" name="nooftournaments" placeholder="Estimated no of tournaments" required>
                <input type="number" class=" reqinput-border form-control ml-3 col-11 col-md-3" id="noofteams" name="noofteams" placeholder="Estimated no of teams" required>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                <input type="number" class=" reqinput-border form-control ml-3 col-11 col-md-6" id="noofmatches" name="noofmatches" placeholder="No of matches" required>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
