...
<div class="container" id="reqform-container">
    <div class="container pl-5 pr-0" id="outline-request">
        <div class="row mt-5 mb-3 pt-5 pb-2 col-12 d-flex justify-content-center">    
            <h3 id="req-head"> Premier - Diplom </h3> <!-- Change names in this line -->
        </div>    
        <div class="row d-flex col-12 px-0 justify-content-center">
            <form class="col-12 px-0" action="./requestforms/DiplomerSubmit.php" enctype="multipart/form-data" method="POST" id="detail-form">
                <div id="div2" class="form-group row d-flex col-12 justify-content-center">
                <input type="number" class=" reqinput-border form-control ml-3 col-11 col-md-6" id="quantity1" min="0" name="noofdiplomers" placeholder="Number of Diplomers" required>
                <div class="form-group row d-flex col-10 mt-3 justify-content-center">
                  <label class="col-5 col-md-3 text-center">Own Design</label>
                  <input type="checkbox" class=" reqinput-border form-control mt-1 col-11 col-md-1" id="OwnDesign" name="OwnDesign" value="OwnDesign">
