...
<div class="container" id="reqform-container">
    <div class="container pl-5 pr-0" id="outline-request">
        <div class="row mt-5 mb-3 pt-5 pb-2 col-12 d-flex justify-content-center">    
            <h3 id="req-head"> Idrettsreiser - Fotballbilletter</h3> <!-- Change names in this line -->
        </div>    
        <div class="row d-flex col-12 px-0 justify-content-center">
            <form class="col-12 px-0" action="./requestforms/ticketsSubmit.php" enctype="multipart/form-data" method="POST" id="detail-form">
                <div class="form-group row d-flex col-12 justify-content-center">
                  <input type="number" class="reqinput-border form-control ml-4 col-11 col-md-3" id="quantity1" min="0" name="quantity1" placeholder="No of tickets" required>
                  <input type="text" class="reqinput-border form-control col-11 col-md-3" id="quantity2" min="0" name="quantity2" placeholder="Home Team" required>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                  <label>Ordinary tickets</label>
                  <input type="radio" class="reqinput-border form-control col-11 col-md-1" id="ordinary" name="tickettype" value ="Ordinary tickets" checked required>
                  <label>Premium/VIP tickets</label>
                  <input type="radio" class="reqinput-border form-control col-11 col-md-1" id="premium" name="tickettype" value ="Premium/VIP tickets" required>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                  <input type="text" class="reqinput-border form-control ml-4 col-11 col-md-6" id="timeandopponent" name="timeandopponent" placeholder="Desirable travel time or desired opponent" required>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                  <label class="mt-2"> <b>Fill room details only, if you need accomodation: </b> </label>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                  <input type="number" class="reqinput-border form-control ml-4 col-11 col-md-3" id="quantity3" min="0" name="quantity3" placeholder="No of single rooms">
                  <input type="number" class="reqinput-border form-control col-11 col-md-3" id="quantity4" min="0" name="quantity4" placeholder="No of Double rooms">
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                  <input type="number" class="reqinput-border form-control ml-4 col-11 col-md-6" id="quantity5" min="0" name="quantity5" placeholder="No of Triple rooms">
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
