...
<div class="container" id="reqform-container">
    <div class="container pl-5 pr-0" id="outline-request">
        <div class="row mt-5 mb-3 pt-5 pb-2 col-12 d-flex justify-content-center">    
            <h3 id="req-head"> Reklame – Arenareklame/skilt/banner</h3> <!-- Change names in this line -->
        </div>    
        <div class="row d-flex col-12 px-0 justify-content-center">
            <form class="col-12 px-0" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" method="POST" id="detail-form">
                <div class="form-group row d-flex col-12 justify-content-center">
                    <input type="number" class=" reqinput-border form-control ml-3 col-11 col-md-6" id="num-of-banners" name="num-of-banners" placeholder="Number of banners/signs" min="1" required>
                    <input type="number" class=" reqinput-border form-control ml-3 col-11 col-md-6" id="size-of-articles" name="size-of-articles" placeholder="Size of banners/signs" min="1" required>            
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                    <label class="col-5 col-md-4 text-center ml-3">Need Design Help? </label>
                    <input type="checkbox" class=" reqinput-border form-control mt-1 col-11 col-md-1" id="designhelp" name="designhelp" value="designhelp">
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                <textarea class=" reqinput-border form-control ml-3 col-11 col-md-6" id="description-banners" name="description-banners" placeholder="Other relevant information " rows="5"></textarea>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
