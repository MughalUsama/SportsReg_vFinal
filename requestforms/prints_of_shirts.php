...
<div class="container" id="reqform-container">
    <div class="container pl-5 pr-0" id="outline-request">
        <div class="row mt-5 mb-3 pt-5 pb-2 col-12 d-flex justify-content-center">    
            <h3 id="req-head"> Reklame – Trykk av drakter og utstyr  </h3> <!-- Change names in this line -->
        </div>    
        <div class="row d-flex col-12 px-0 justify-content-center">
            <form class="col-12 px-0" action="./requestforms/printshirtSubmit.php" enctype="multipart/form-data" method="POST" id="detail-form">
                <div class="form-group row d-flex col-12 justify-content-center">
                    <input type="number" class=" mt-1 reqinput-border form-control ml-3 col-11 col-md-6" id="num-of-articles-print" name="num-of-articles-print" placeholder="Number of articles to print" min="1" required>
                    <input type="number" class=" mt-1 reqinput-border form-control ml-3 col-11 col-md-6" id="prints-per-article" name="prints-per-article" placeholder="Prints per article" min="1" required>            
                </div>
                
                <div class="form-group row d-flex col-12 justify-content-center">
                    <label class="text-center ml-3">Need Print Marks</label>
                    <input type="checkbox" class=" reqinput-border form-control mt-1 col-11 col-md-1" id="needprintmarks" name="needprintmarks" value="needprintmarks">
                </div>   
                <div class="form-group row d-flex col-12 justify-content-center">
                <textarea class=" reqinput-border form-control ml-3 col-11 col-md-6" id="description-prints-of-shirts" name="description" placeholder="Provide detailed information about your needs." rows="5"  ></textarea>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
