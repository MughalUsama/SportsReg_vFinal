...
<div class="container" id="reqform-container">
    <div class="container pl-5 pr-0" id="outline-request">
        <div class="row mt-5 mb-3 pt-5 pb-2 col-12 d-flex justify-content-center">    
            <h3 id="req-head"> Trykkeritjenester - Trykk av drakter og utstyr</h3> <!-- Change names in this line -->
        </div>    
        <div class="row d-flex col-12 px-0 justify-content-center">
            <form class="col-12 px-0 py-3" action="./requestforms/printingshirtsSubmit.php" enctype="multipart/form-data" method="POST" id="detail-form">
                <div id="div1" class="form-group row d-flex col-12 justify-content-center">
                <input type="number" class=" reqinput-border form-control ml-3 col-11 col-md-4" id="quantity1" min="0" name="quantity1" placeholder="Total no of prints" required>
                <input type="number" class=" reqinput-border form-control ml-3 col-11 col-md-4" id="quantity2" min="0" name="quantity2" placeholder="No of different prints" required>
                </div>
