...
<div class="container" id="reqform-container">
    <div class="container pl-5 pr-0" id="outline-request">
        <div class="row mt-5 mb-3 pt-5 pb-2 col-12 d-flex justify-content-center">    
            <h3 id="req-head"><?php echo($_SESSION["sport"])?> -  Trykkeritjenester - Trykk av årsrapporter, brosjyrer m.m. </h3> <!-- Change names in this line -->
        </div>    
        <div class="row d-flex col-12 px-0 justify-content-center">
            <form class="col-12 px-0" action="./requestforms/ARBSubmit.php" enctype="multipart/form-data" method="POST" id="detail-form">
                <div id="div2" class="form-group row d-flex col-12 justify-content-center">
                <input type="number" class=" reqinput-border form-control ml-3 col-11 col-md-3" id="quantity1" min="0" name="noofprints" placeholder="Total number of Prints" required>
                <input type="text" class=" reqinput-border form-control ml-1 col-11 col-md-3" id="quantity2" name="size" placeholder="Size" required>
                </div>
                <div class="form-group row d-flex col-10 ml-5 justify-content-center">
                  <label class="col-5 col-md-3 text-center ml-4">Print-ready file</label>
                  <input type="checkbox" class=" reqinput-border form-control mt-1 col-11 col-md-1" id="PrintReadyFile" name="PrintReadyFile" value="PrintReadyFile">
                  <label class="col-5 col-md-3">Need design-help</label>
                  <input type="checkbox" class=" reqinput-border form-control mt-1 col-11 col-md-1" id="NeedDesignHelp" name="NeedDesignHelp" value="NeedDesignHelp">
                </div>
