...
<head>
    ...
    <!-- <link rel='stylesheet' type='text/css' media='screen' href='medicalmsgcss_ali.css'> -->
...
<div class="container" id="reqform-container">
    <div class="container pl-5 pr-0" id="outline-request">
        <div class="row mt-5 mb-3 pt-5 pb-2 col-12 d-flex justify-content-center">    
            <h3 id="req-head"> Fotograf – Fotograf </h3> <!-- Change names in this line -->
        </div>    
        <div class="row d-flex col-12 px-0 justify-content-center">
            <form class="col-12 px-0" action="./requestforms/photoSubmit.php" enctype="multipart/form-data" method="POST" id="detail-form">
                <div class="form-group row d-flex col-12 justify-content-center">
                    <input type="date" class=" reqinput-border form-control ml-3 col-6 col-md-6" id="date-of-photo" name="date-of-photo" placeholder="Date of photo" min="1" required>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                    <label class="text-center ml-3">Team Photo</label>
                    <input type="checkbox" class=" reqinput-border form-control mt-1 col-11 col-md-1" id="TeamPhoto" name="TeamPhoto" value="TeamPhoto">
                    <label class="text-center ml-3">Player Photo</label>
                    <input type="checkbox" class=" reqinput-border form-control mt-1 col-11 col-md-1" id="PlayerPhoto" name="PlayerPhoto" value="PlayerPhoto">
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                    <label class="text-center ml-3">Action Photo</label>
                    <input type="checkbox" class=" reqinput-border form-control mt-1 col-11 col-md-1" id="ActionPhoto" name="ActionPhoto" value="ActionPhoto">
                </div>                
                <div class="form-group row d-flex col-12 justify-content-center">
                    <input type="number" class=" reqinput-border form-control ml-3 col-11 col-md-6" id="num-of-teams" name="num-of-teams" placeholder="Number of teams" min="1" required>
                    <input type="number" class=" reqinput-border form-control ml-3 col-11 col-md-6" id="num-of-players" name="num-of-players" placeholder="Number of players" min="1" required>            
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                <textarea class=" reqinput-border form-control ml-3 col-11 col-md-6" id="description-players" name="description" placeholder="Other relevant information." rows="5"  ></textarea>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
