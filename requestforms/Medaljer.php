...
<div class="container" id="reqform-container">
    <div class="container pl-5 pr-0" id="outline-request">
        <div class="row mt-5 mb-3 pt-5 pb-2 col-12 d-flex justify-content-center">    
            <h3 id="req-head"> <?php echo($_SESSION["sport"]); ?> - Premier - Medaljer/pokaler</h3> <!-- Change names in this line -->
        </div>    
        <div class="row d-flex col-12 px-0 justify-content-center">
            <form class="col-12 px-0 py-3" action="./requestforms/MedaljerSubmit.php" enctype="multipart/form-data" method="POST" id="detail-form">
                <div id="div1" class="form-group row d-flex col-12 justify-content-center">
                <input type="number" class=" reqinput-border form-control ml-3 col-11 col-md-4" id="quantity1" min="0" name="Total_Transfer_marks" placeholder="Number of medals" required>
                <input type="number" class=" reqinput-border form-control ml-1 col-11 col-md-4" id="quantity2" min="0" name="No_of_Diff_Transfer_marks" placeholder="Number of trophies" required>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                <textarea class=" reqinput-border form-control ml-3 col-11 col-md-8" id="description" name="description" placeholder="Provide detailed information about your needs" rows="5"  ></textarea>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                <input class=" reqinput-border form-control ml-3 col-11 col-md-8" type="file" name="fileToUpload" id="fileToUpload" accept=".txt,.xlsx,.png,.jpg,.jpeg,.pdf,.pptx,.doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document">
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                     <?php echo($req_er) ;?>
                </div>
