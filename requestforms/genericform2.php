...
<div class="container" id="reqform-container">
    ...
    <div class="container pl-5 pr-0" id="outline-request">
        ...
        <div class="row d-flex col-12 px-0 justify-content-center">
            <form class="col-12 px-0" action="./requestforms/generic2submit.php" enctype="multipart/form-data" method="POST" id="detail-form">
                <div class="form-group row d-flex col-12 justify-content-center">
                <textarea class=" reqinput-border form-control ml-3 col-11 col-md-6" id="description" name="description" placeholder="Other information" rows="5"></textarea>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
