...
<div class="container" id="reqform-container">
    <div class="container pl-5 pr-0" id="outline-request">
        <div class="row mt-5 mb-3 pt-5 pb-2 col-12 d-flex justify-content-center">    
            <h3 id="req-head"> Medisinsk – Isposer  </h3> <!-- Change names in this line -->
        </div>    
        <div class="row d-flex col-12 px-0 justify-content-center">
            <form class="col-12 px-0" action="./requestforms/ice_packSubmit.php" enctype="multipart/form-data" method="POST" id="detail-form">
                <div class="form-group row d-flex col-12 justify-content-center">
                <input type="number" class=" reqinput-border form-control ml-3 col-11 col-md-6" id="num-of-icepacks" name="num-of-icepacks" placeholder="Number of ice pack" min="1" required>
                </div>
                <div class="form-group row d-flex col-12 justify-content-center">
                <textarea class=" reqinput-border form-control ml-3 col-11 col-md-6" id="description-icepack" name="description-icepack" placeholder="Other relevant information." rows="5"  ></textarea>
                </div><div class="form-group row d-flex col-12 justify-content-center">
